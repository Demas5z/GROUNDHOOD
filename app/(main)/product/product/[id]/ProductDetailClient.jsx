  ...
  return (
    <main style={{ padding: '40px', maxWidth: '1400px', margin: '0 auto' }}>
      ...
      <div style={{ display: 'flex', gap: '8px', alignItems: 'center', marginBottom: '48px' }}>
        <Link href="/" className="text-label" style={{ textDecoration: 'none', color: '#a8a69f' }}>Home</Link>
        <span style={{ color: '#a8a69f' }}>/</span>
        <Link href="/shop" className="text-label" style={{ textDecoration: 'none', color: '#a8a69f' }}>Shop</Link>
        <span style={{ color: '#a8a69f' }}>/</span>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '60px', marginBottom: '80px' }}>
        ...
        <div style={{ paddingTop: '8px' }}>
          ...
          <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap' }}>
            ...
            <button className="btn-pill" style={{ padding: '14px 20px' }} aria-label="Wishlist">
          ...
          {/* Features */}
          <div style={{ marginTop: '40px', borderTop: '1px dotted rgba(212,210,203,0.3)', paddingTop: '32px', display: 'flex', flexDirection: 'column', gap: '12px' }}>
            {[
              'Gratis ongkir pembelian di atas Rp300.000',
              'Pengembalian dalam 3 hari jika tidak sesuai deskripsi',
              'Produk terseleksi & terjamin kualitasnya',
      ...
      {related.length > 0 && (
        <section style={{ borderTop: '1px dotted rgba(212,210,203,0.4)', paddingTop: '64px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '40px' }}>
            ...
            <Link href="/shop" className="btn-pill" style={{ fontSize: '10px' }}>View All</Link>
          </div>
