...
const marqueeItems = ['NEW DROP', '·', 'SHOP NOW', '·', 'GRATIS ONGKIR', '·', 'GROUNDHOOD', '·', 'THRIFT STORE', '·', 'PRELOVED PIECES', '·']

export const metadata = {
  title: 'GROUNDHOOD | Thrift Store — Secondhand Pilihan',
  description: 'Thrift store produk secondhand pilihan. Temukan pakaian unik berkualitas dengan harga terjangkau.',
}
    ...
    <main>
      ...
      <section style={{
        ...
        <div style={{ position: 'relative', zIndex: 2, maxWidth: '1400px', margin: '0 auto', width: '100%' }}>
          <FadeUp delay={0}>
            <p className="text-label" style={{ marginBottom: '16px' }}>THRIFT STORE — SECONDHAND PILIHAN</p>
          </FadeUp>
          <FadeUp delay={150}>
            <h1 style={{
          ...
          <FadeUp delay={300}>
            <div style={{ display: 'flex', gap: '16px', flexWrap: 'wrap' }}>
              <Link href="/shop" className="btn-pill btn-pill-filled">Belanja Sekarang</Link>
              <Link href="/about" className="btn-pill">Tentang Kami</Link>
            </div>
          </FadeUp>
        </div>
        <div style={{
      ...
      <section style={{
        ...
        <div style={{ position: 'relative', zIndex: 2 }}>
          <FadeUp>
            <p className="text-label" style={{ marginBottom: '24px' }}>Filosofi Kami</p>
          </FadeUp>
          <FadeUp delay={100}>
            <h2 style={{
              ...
              &ldquo;Gaya Unikmu<br />Dimulai dari Sini.&rdquo;
            </h2>
          </FadeUp>
          <FadeUp delay={200}>
            <p style={{ color: '#a8a69f', maxWidth: '480px', margin: '0 auto 40px', lineHeight: '1.8' }}>
              GROUNDHOOD hadir untuk mereka yang tahu nilai sebuah pakaian. Produk thrift pilihan,
              berkualitas, dan terjangkau — karena style terbaik tidak harus baru.
            </p>
            <Link href="/about" className="btn-pill">Tentang Kami</Link>
          </FadeUp>
        </div>
          ...
          <FadeUp>
            <div className="grid-cell" style={{ position: 'relative', overflow: 'hidden', minHeight: '520px' }}>
              ...
              <div style={{ position: 'absolute', bottom: '36px', left: '36px', right: '36px' }}>
                <p className="text-label" style={{ marginBottom: '8px' }}>Baru Masuk</p>
                <h3 style={{ fontSize: '2rem', fontWeight: '700', textTransform: 'uppercase', marginBottom: '20px', letterSpacing: '-0.01em' }}>Stok Terbaru</h3>
                <Link href="/shop?cat=new" className="btn-pill">Lihat Baru</Link>
              </div>
            </div>
          </FadeUp>
          <FadeUp delay={150}>
            <div className="grid-cell" style={{ position: 'relative', overflow: 'hidden', minHeight: '520px' }}>
              ...
              <div style={{ position: 'absolute', inset: 0, background: 'linear-gradient(to top, rgba(26,26,26,0.9) 0%, transparent 60%)' }} />
              <div style={{ position: 'absolute', bottom: '36px', left: '36px', right: '36px' }}>
                <p className="text-label" style={{ marginBottom: '8px' }}>Favorit Pembeli</p>
                <h3 style={{ fontSize: '2rem', fontWeight: '700', textTransform: 'uppercase', marginBottom: '20px', letterSpacing: '-0.01em' }}>Paling Diminati</h3>
                <Link href="/shop" className="btn-pill">Lihat Semua</Link>
              </div>
            </div>
          </FadeUp>
        </div>
      ...
      <section style={{ padding: '0 40px 80px', maxWidth: '1400px', margin: '0 auto' }}>
        <FadeUp>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: '48px', flexWrap: 'wrap', gap: '16px' }}>
            <div>
              <p className="text-label" style={{ marginBottom: '8px' }}>Stok Terbaru</p>
              <h2 style={{ fontSize: 'clamp(1.8rem, 4vw, 3rem)', fontWeight: '700', letterSpacing: '-0.02em', textTransform: 'uppercase', color: '#d4d2cb' }}>
        ...
        <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
          <FadeUp>
            <div style={{ textAlign: 'center', marginBottom: '60px' }}>
              <p className="text-label" style={{ marginBottom: '8px' }}>Kata Mereka</p>
              <h2 style={{ fontSize: 'clamp(1.8rem, 4vw, 3rem)', fontWeight: '700', letterSpacing: '-0.02em', textTransform: 'uppercase', color: '#d4d2cb' }}>
      ...
      <section style={{
        ...
        <div style={{
          ...
          {[
            ...
            { num: '200+', label: 'Produk Unik' },
            { num: '100%', label: 'Produk Terseleksi' },
          ].map((stat, i) => (
      ...
      <section style={{
        ...
        <FadeUp>
          <p className="text-label" style={{ marginBottom: '16px' }}>Siap Berburu?</p>
          <h2 style={{
            ...
            Thrift Sekarang.<br />Tampil Beda.
          </h2>
          <Link href="/shop" className="btn-pill btn-pill-filled" style={{ fontSize: '12px', padding: '14px 40px' }}>
            Jelajahi Koleksi
          </Link>
        </FadeUp>
      </section>
